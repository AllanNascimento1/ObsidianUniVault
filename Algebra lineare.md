...
Attraverso il prodotto scalare possiamo anche trovare facilmente delle rette ortogonali ad altre rette nel piano, e nel spazio, troviamo rette parallele ai piani attraverso la loro equazione cartesiana. 
**Piano $V^2$**
...
##### Operazioni
Per definire l'insieme delle n-uple $\Bbb R^n$ come un gruppo  dobbiamo introdurre le operazioni  